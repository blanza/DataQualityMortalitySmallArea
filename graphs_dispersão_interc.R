...
## Separando por sexo e info geografica
...
## gráficos separados
#windows()
#figf = ggarrange(fig1f, fig2f, fig3f, ncol=3, nrow=1, common.legend = TRUE, legend="bottom")
#annotate_figure(figf, top = text_grob("Intercensal female adult mortality probabilities\nin small areas of Brazil, 1980-2010", color = "red", face = "bold", size = 14))
...
## gráficos separados
#windows()
#figfp = ggarrange(fig1fp, fig2fp, fig3fp, ncol=3, nrow=1, common.legend = TRUE, legend="bottom")
#annotate_figure(figfp, top = text_grob("Intercensal female adult mortality probabilities\nin small areas of Brazil, 1980-2010", color = "red", face = "bold", size = 14))
